...
public class OrderVO {
	...
	public OrderVO(int productNo, int cartQuantity, int productDelivery, int productPayment, String userZipcode,
			String userAddress1, String userAddress2, String productName, String userId, String productCategory,
			String orderState, String userEmail, String userName, String userPhone, String userComment) {
