...
CREATE TABLE `reply` (
  ...
  `replyContent` varchar(1024) COLLATE utf8_bin DEFAULT NULL,
  `userId` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `userName` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `replyRe_ref` int(11) DEFAULT NULL,
  `replyRe_lev` int(11) DEFAULT NULL,
  `replyRe_seq` int(11) DEFAULT NULL,
  `replyWriteDate` date DEFAULT NULL,
  PRIMARY KEY (`replyNo`)
...
-- Dump completed on 2020-06-25 17:44:55
