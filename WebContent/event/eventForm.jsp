...
<body>
		<h1 style="text-align: center;">새글 쓰기</h1>
 		<form action="${contextPath}/eve/addEvent.do"
 			  name="eventForm"
 			  method="post"
 			  ...
 			  <table border=0 align=center >
 			  	...
 			  	<tr>
 			  		...
 			  		<td colspan="2"><input type="text" maxlength="500" name="eventTitle" required/></td>
 			  	</tr>
 			  	<tr>
 			  		<td align="right" valign="top"><br>글 내용:</td>
 			  		<td colspan="2">
 			  			<textarea name="eventContent"  rows="10" cols="65" maxlength="4000" required></textarea>
 			  		</td>
 			  	</tr>
 			  	<tr>
 			  		<td align="right">이미지 파일 첨부 :</td>
 			  		<td><input type="file" name="eventImageFileName" onchange="readURL(this);" required></td>
 			  		<td id="tdImg"></td>
 			  	</tr>
 			  	<tr>
 			  		<td align="right"></td>
