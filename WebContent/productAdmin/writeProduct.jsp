					...
					<tr>
						...
						<td>
							<div class="form-inline">
								<input class="form-control" type="number" name="productPrice" id="productPrice" min="0" max="99999999" value="0" required />
							</div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<div class="custom-file">
								<input class="custom-file-input" type="file" name="productImageName" id="productImageName" onchange="showPreview(this, 'image')" required />
