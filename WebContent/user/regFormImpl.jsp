...
location.href="${contextPath}/user/regFormImpl.jsp";}
</script>
<meta charset="UTF-8">
<title>회원가입창</title>
</head>
<body>
<form action="${contextPath}/user/userForm.jsp" name="form" method="post">
