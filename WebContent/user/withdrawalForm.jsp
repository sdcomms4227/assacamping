...
<div class="super_container">
	...
	<section class="section-user">
		<div class="container body-container my-5 py-5">
			<form class="withdrawalForm" action="${contextPath}/userServlet/withdrawalAction.do" method="post" >
				...
				<button type="submit" class="btn btn-lg btn-danger btn-block my-5">탈퇴하기</button>
			</form>
		</div>
	</section>
